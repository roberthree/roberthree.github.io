...
Averaging over the most recent velocities, the next iteration's possible story points is given by:

$$\text{Possible story points} = \text{Mean velocity of recent iterations} \times \text{Team's anticipated coarse capacity}$$
